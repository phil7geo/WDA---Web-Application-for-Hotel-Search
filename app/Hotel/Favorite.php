<?php
 ...
 class Favorite extends BaseService
 {
    ...
    public function isFavorite($roomId,$userId)
    {
      ...
      $favorite = $this->fetch('SELECT * FROM favorite WHERE room_id = :room_id
        AND user_id = :user_id', $parameters);
    ...
    public function removeFavorite($roomId, $userId)
    {
            ...
            return $this->execute('DELETE FROM favorite WHERE room_id = :room_id AND user_id = :user_id', $parameters);
